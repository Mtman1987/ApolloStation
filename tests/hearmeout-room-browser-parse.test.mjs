...
test("HearMeOut v3 room browser bundle parses before deployment", () => {
  ...
  for (const pattern of [/Enter password/, /Audio settings/, /Movies and watch player/, /Leave room/, /Delete room/, /Timeout 10 minutes/, /Watch together/]) assert.match(browserSource, pattern);
