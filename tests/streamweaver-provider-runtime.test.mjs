...
test("supervised Chat Gateway validates and authenticates the separate StreamWeaver runtime", async () => {
  ...
  try {
    ...
    assert.deepEqual(ready.consumers, ["commlink-live-chat", "streamweaver.bot-actions", "streamweaver.bot-relay", "streamweaver.donor-commands", "streamweaver.economy", "streamweaver.installed-flows", "streamweaver.persona", "streamweaver.provider-awards"]);
