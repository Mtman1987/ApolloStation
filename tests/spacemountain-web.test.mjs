...
test("Sprite artifacts are deny-by-default and the supervised runner cannot register a service", () => {
  ...
  assert.deepEqual(allowed, ["github.com", "*.github.com", "githubusercontent.com", "*.githubusercontent.com", "npmjs.org", "*.npmjs.org", "huggingface.co", "*.huggingface.co", "hf.co", "*.hf.co", "spmt.live", "api.openai.com"]);
