...
test("Sprite artifacts are deny-by-default and the supervised runner cannot register a service", () => {
  ...
  assert.deepEqual(allowed, ["github.com", "*.github.com", "githubusercontent.com", "*.githubusercontent.com", "npmjs.org", "*.npmjs.org", "huggingface.co", "*.huggingface.co", "hf.co", "*.hf.co", "spmt.live", "api.openai.com", "api.meshy.ai", "assets.meshy.ai", "api.keentools.io", "*.amazonaws.com", "hmo-dj-worker.fly.dev", "youtube.com", "*.youtube.com", "youtu.be", "*.googlevideo.com", "*.ytimg.com", "youtubei.googleapis.com", "storage.googleapis.com", "hearmeout-main.fly.dev"]);
  ...
  assert.match(runner, /SPMT_AVATAR_AI_OUTBOUND_MODE:"enabled"/);
