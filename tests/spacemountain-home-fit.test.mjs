...
test("SpaceMountain home reserves rows for the cropped logo and launch actions", () => {
  assert.match(themed, /\.spmt-space-root\[data-spmt-view="home"\] \.spmt-hero-copy\{[^}]*display:grid;[^}]*grid-template-rows:minmax\(0,1fr\) auto;/);
