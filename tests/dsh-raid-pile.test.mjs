...
test('four-hour hold creates a soft canonical handoff without requiring the old streamer to end', t => {
  const { store, setNow } = fixture(t); const tenant = 'tenant';
  ...
  assert.match(handoffs[0].message, /canonical pile is now/i);
