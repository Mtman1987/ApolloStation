...
export class SqliteAuthorityStore implements AuthorityStore, AuthStore, ControlStore, UsageLedgerStoreV1 {
  ...
  private migrate() {
    this.db.exec(`
      ...
      CREATE TABLE IF NOT EXISTS usage_events(tenant_id TEXT NOT NULL, idempotency_key TEXT NOT NULL, period TEXT NOT NULL, resource TEXT NOT NULL, execution_target TEXT NOT NULL, delta INTEGER NOT NULL, occurred_at TEXT NOT NULL, body TEXT NOT NULL, PRIMARY KEY(tenant_id, idempotency_key)) STRICT;
      CREATE INDEX IF NOT EXISTS usage_events_totals ON usage_events(tenant_id, period, resource, execution_target);
