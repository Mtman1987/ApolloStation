...
OUTPUT = ROOT / "apps/nebula-arcade/assets/nebula-arcade-games-showcase.gif"
ICON = ROOT / "apps/nebula-arcade/assets/nebula-arcade-icon.png"
WIDTH, HEIGHT = 1200, 675
OUTPUT_WIDTH, OUTPUT_HEIGHT = 800, 450

GAMES = [
    ("Tag", "core", "Persistent cross-channel community tag"),
...
ACCENTS = {
    "core": (103, 232, 249), "party": (244, 114, 182),
    "creative": (167, 139, 250), "strategy": (74, 222, 128),
    "race": (251, 146, 60), "music": (250, 204, 21), "word": (96, 165, 250),
}
