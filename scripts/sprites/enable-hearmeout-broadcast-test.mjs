...
export async function enableHearMeOutBroadcastTest(dataRoot, mediaRoot) {
  ...
  config.broadcast = {ffmpegBinary, ffprobeBinary, singleProgram:true, executionUserId,lounge:config.broadcast?.lounge??{roomId:'system-spacemountainlive-lounge',name:'24-Hour Lounge',radioSeed:'A varied mix of music matching recent 24-Hour Lounge requests',twitchChannel:'mtman1987'}};
