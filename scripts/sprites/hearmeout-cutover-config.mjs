...
export async function hearMeOutCutoverEnvironment(dataRoot) {
  ...
  return {
    ...
    ...(config.broadcast ? { HEARMEOUT_BROADCAST_CACHE_PATH: resolve(root, 'hearmeout-broadcast-cache'), HEARMEOUT_FFMPEG_BINARY: config.broadcast.ffmpegBinary, HEARMEOUT_FFPROBE_BINARY: config.broadcast.ffprobeBinary } : {}),
