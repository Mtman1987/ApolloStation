...
import type { AppRegistryEntryV1, AppRegistryFiltersV1, AppRegistryV1 } from './registry-contract.js';
export type {
  AppAccessStateV1,
  AppCatalogStateV1,
  AppRegistryEntryV1,
  AppRegistryFiltersV1,
  AppRegistryV1,
  AppRuntimeStateV1,
...
function appRegistryQuery(filters: AppRegistryFiltersV1 = {}) {
...
export class SpaceMountainClient {
  ...
  apps = {
    list: (filters: AppRegistryFiltersV1 = {}) => this.request(`/api/apps${appRegistryQuery(filters)}`) as Promise<AppRegistryV1>,
    publicList: (filters: AppRegistryFiltersV1 = {}) => this.request(`/api/platform/apps/public${appRegistryQuery(filters)}`, { authMode: 'apiKey' }) as Promise<AppRegistryV1 & { key: unknown }>,
    get: (appId: string) => this.request(`/api/apps/${encodeURIComponent(appId)}`) as Promise<{ version: 'app-registry.v1'; revision: string; app: AppRegistryEntryV1 }>,
