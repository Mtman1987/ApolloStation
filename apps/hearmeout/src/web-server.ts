...
export const HEARMEOUT_WEB_SURFACE_CONTRACT = Object.freeze({
  ...
  roomUi: ["Create Room", "/api/hearmeout/rooms", "joinRoom", "heartbeatPresence", "listMembers", "getSession", "Commlink", "Music Bot", "Bridge", "Personas", "Watch together", "Leave room", "Delete room", "Green runtime", "No rooms yet", "idle"],
});
