...
export const manifest=assertAppModuleManifestV1({schemaVersion:1,manifestVersion:"spmt.app-manifest/v1",id:"hearmeout",name:"HearMeOut",description:"Voice rooms, synchronized watch and music sessions, Discord Activity, and OBS media outputs.",capabilities:["voice-rooms","livekit","watch-parties","music-queue","youtube-resolution","multi-audio-hls","discord-activity","discord-guilds","discord-channels","discord-messages","discord-embeds","discord-invites","discord-interactions","discord-voice-bridge","obs-now-playing"],surfaces:["shell","standalone","overlay","popout"],requiredScopes:["events:write","identity:read","devices:read"],eventTypes:["hearmeout.room.changed.v1","hearmeout.media-session.changed.v1"],integration:{identity:"connected",events:"native",workspace:"connected",devices:"connected"},workers:[{id:"hmo-dj-worker",role:"media-resolution-cache-and-discord-voice",execution:"elastic",canonicalAuthority:false}]} satisfies AppModuleManifestV1);
