...
'.hmo-home{box-sizing:border-box!important;overflow:hidden!important;border:1px solid var(--spmt-border)!important;border-radius:28px!important}.hmo-hero{max-height:100%!important;overflow:hidden!important;justify-items:center!important;text-align:center!important}.hmo-mark{flex-direction:column!important;gap:4px!important}.hmo-mark img{width:clamp(180px,30vh,300px)!important;height:clamp(180px,30vh,300px)!important}.hmo-app[data-surface="shell"] .hmo-hero h1{font-size:clamp(30px,5vw,58px)!important}.hmo-hero p{margin-left:auto!important;margin-right:auto!important}.hmo-feature-strip,.hmo-hero-actions,.hmo-hero footer{justify-content:center!important}.hmo-room-scroll{scrollbar-width:thin;scrollbar-color:transparent transparent}.hmo-room-scroll:hover{scrollbar-color:color-mix(in srgb,var(--spmt-accent) 62%,transparent) transparent}@media(max-width:560px){.hmo-home{border-radius:22px!important}.hmo-mark img{width:clamp(150px,26vh,220px)!important;height:clamp(150px,26vh,220px)!important}.hmo-app[data-surface="shell"] .hmo-hero h1{font-size:clamp(28px,9vw,44px)!important}}'
