...
const PAGES: readonly BoundedAppPage[] = [
  ...
  },
  {
    ...
    description: "Persistent rooms, LiveKit voice sessions, DJ and watch queues, Discord Activity entry, provider identity, and focused media output.",
    status: "Green donor surface",
    ...
    features: [
      ...
      { title: "DJ / Watch", detail: "Music requests, queue control, search, caching, playback, and synchronized watch state." },
