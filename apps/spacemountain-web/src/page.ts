...
.sandbox-status{top:var(--guard-height);margin-top:7px;background:#06070bea;border-color:#ffffff20;color:#b9bbc4;box-shadow:0 10px 35px #0009;font-size:10px}
...
@media(max-width:700px){:root{--guard-height:68px}.sandbox-guardrail{align-items:flex-start}.auth-view{padding-top:130px}.auth-panels{grid-template-columns:1fr}.auth-product-logo{height:120px}.auth-intro h1{font-size:48px}.auth-intro ul{grid-template-columns:1fr}.sandbox-status{top:var(--guard-height)}}
