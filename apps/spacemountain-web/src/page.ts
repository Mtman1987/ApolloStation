...
/* Phone-only shell overrides. Desktop/tablet rules above are unchanged. */
@media(max-width:700px){
:root{--guard-height:92px}
body{background-attachment:scroll}
.sandbox-guardrail{height:var(--guard-height);min-height:var(--guard-height);display:grid;grid-template-columns:minmax(0,1fr);align-content:start;gap:5px;padding:8px 10px;overflow:hidden}
.sandbox-guardrail>div{display:flex;align-items:center;gap:7px;min-width:0;white-space:nowrap;overflow:hidden}.sandbox-guardrail>div span{overflow:hidden;text-overflow:ellipsis}.sandbox-guardrail strong{flex:0 0 auto}
.sandbox-guardrail nav{display:flex;flex-wrap:nowrap;justify-content:flex-start;gap:5px;min-width:0;overflow-x:auto;overflow-y:hidden;scrollbar-width:none}.sandbox-guardrail nav::-webkit-scrollbar{display:none}.sandbox-guardrail nav>*{flex:0 0 auto}.sandbox-status{order:0;max-width:145px;flex-basis:auto!important;padding-inline:7px}.sandbox-guardrail button{min-height:30px;padding:5px 9px}.sandbox-guardrail a{display:none}
#shell-view{padding-top:var(--guard-height)}.sandbox-footer{display:none}
.spmt-space-root{min-height:calc(100dvh - var(--guard-height))!important;overflow-x:hidden!important}
.spmt-shell-header-stack{position:fixed!important;top:calc(var(--guard-height) + 7px)!important;left:8px!important;right:8px!important;width:auto!important;gap:5px!important}
.spmt-cosmic-header{min-height:54px!important;border-radius:18px!important;padding:6px 8px!important;gap:7px!important;overflow:visible!important}
.spmt-brand{gap:5px!important}.spmt-brand img{width:40px!important;height:34px!important}.spmt-brand strong{display:none!important}.spmt-header-links,.spmt-header-clocks,.spmt-header-balance{display:none!important}.spmt-header-actions{margin-left:auto!important;gap:5px!important}.spmt-header-actions button{min-width:38px!important;min-height:38px!important;padding:7px!important;border-radius:12px!important}.spmt-account{gap:4px!important}.spmt-account>span,.spmt-account>strong{display:none!important}.spmt-live-tray{position:fixed!important;top:calc(var(--guard-height) + 68px)!important;left:10px!important;right:10px!important;width:auto!important;max-height:55dvh!important}
.spmt-space-main{width:100%!important;margin:0!important;padding:78px 12px calc(90px + env(safe-area-inset-bottom)) 12px!important;min-height:calc(100dvh - var(--guard-height))!important}
.spmt-space-root[data-spmt-view="home"]{height:auto!important;min-height:calc(100dvh - var(--guard-height))!important;overflow-y:auto!important}.spmt-space-root[data-spmt-view="home"] .spmt-space-shell,.spmt-space-root[data-spmt-view="home"] .spmt-space-main{height:auto!important;min-height:calc(100dvh - var(--guard-height))!important}.spmt-space-root[data-spmt-view="home"] .spmt-space-main{display:block!important;padding-bottom:calc(90px + env(safe-area-inset-bottom))!important}.spmt-space-root[data-spmt-view="home"] .spmt-hero{height:auto!important;max-height:none!important;min-height:0!important}
.spmt-hero{display:grid!important;grid-template-columns:1fr!important;min-height:0!important;border-radius:24px!important;padding:20px 16px!important;gap:18px!important;align-items:start!important}.spmt-hero::after{width:280px!important;height:280px!important;right:-160px!important;top:-170px!important}.spmt-hero-logo,.spmt-hero-logo-large,.spmt-space-root[data-spmt-view="home"] .spmt-hero-logo-large{width:min(300px,90vw)!important;height:76px!important;max-height:none!important;margin:-8px 0 0 -13px!important}.spmt-hero h1{font-size:clamp(30px,10vw,42px)!important;margin:8px 0 10px!important}.spmt-hero p{font-size:13px!important;line-height:1.55!important}.spmt-space-root[data-spmt-view="home"] .spmt-hero-tagline{font-size:11px!important}.actions,.spmt-space-root[data-spmt-view="home"] .actions{display:grid!important;grid-template-columns:1fr!important;width:100%!important;gap:9px!important;margin-top:16px!important}.actions button{width:100%!important;min-height:48px!important}
.spmt-metrics,.spmt-space-root[data-spmt-view="home"] .spmt-metrics{width:100%!important;grid-template-columns:repeat(2,minmax(0,1fr))!important;gap:9px!important;align-self:stretch!important}.spmt-metrics>div,.spmt-space-root[data-spmt-view="home"] .spmt-metrics>div{min-height:92px!important;padding:13px!important;border-radius:18px!important}.spmt-metrics strong{font-size:25px!important}.spmt-metrics span{font-size:8px!important}
.spmt-section{margin-top:12px!important;border-radius:22px!important;padding:16px!important}.spmt-section>header{align-items:flex-start!important;gap:10px!important}.spmt-section h2{font-size:20px!important}.spmt-app-grid,.spmt-app-grid.wide{grid-template-columns:1fr!important;gap:10px!important;margin-top:14px!important}.spmt-app-card{min-height:0!important;border-radius:20px!important;padding:15px!important}.spmt-app-card p{min-height:0!important}.app-icon{width:54px!important;height:54px!important;border-radius:15px!important}
.spmt-rocket-dock{position:fixed!important;z-index:500!important;left:8px!important;right:8px!important;top:auto!important;bottom:calc(8px + env(safe-area-inset-bottom))!important;width:auto!important;height:68px!important;min-height:68px!important;padding:6px!important;border-radius:22px!important;display:flex!important;overflow:hidden!important}.spmt-dock-orbit,.spmt-rocket-dock footer,.spmt-dock-apps,.spmt-dock-account{display:none!important}.spmt-rocket-dock nav{display:flex!important;flex:1!important;min-width:0!important;min-height:0!important;flex-direction:row!important;overflow:visible!important}.spmt-dock-core{display:flex!important;flex:1!important;min-width:0!important;flex-direction:row!important;gap:3px!important;padding:0!important;border:0!important}.spmt-rocket-dock nav button{flex:1 1 0!important;min-width:0!important;min-height:54px!important;padding:5px 2px!important;border-radius:15px!important;display:flex!important;flex-direction:column!important;justify-content:center!important;gap:3px!important;text-align:center!important}.spmt-rocket-dock nav button:hover{transform:none!important}.spmt-rocket-dock nav button.active{box-shadow:inset 0 -3px 0 var(--accent)!important;background:linear-gradient(180deg,color-mix(in srgb,var(--accent) 13%,transparent),transparent)!important}.spmt-rocket-dock nav label{font-size:8px!important;max-width:100%!important;overflow:hidden!important;text-overflow:ellipsis!important;white-space:nowrap!important}.spmt-dock-app-icon{width:18px!important;height:18px!important}
.spmt-page-title{margin-bottom:12px!important}.spmt-page-title h1{font-size:30px!important}.spmt-command-grid,.spmt-context-grid,.spmt-slot-grid,.spmt-account-grid,.cosmo-layout,.cosmo-shell,.cosmo-workspace,.cosmo-grid{grid-template-columns:1fr!important}.cosmo-rail,.cosmo-feed,.cosmo-composer{min-width:0!important;width:100%!important;max-width:100%!important}.cosmo-feed{overflow-x:hidden!important}.spmt-section table{display:block!important;width:100%!important;overflow-x:auto!important}.spmt-section pre{max-width:100%!important;overflow-x:auto!important}
#developer-dialog,#record-dialog{width:calc(100vw - 16px)!important;max-height:calc(100dvh - 24px)!important;padding:16px!important;border-radius:20px!important}.dialog-heading h2{font-size:27px!important}.manifest-tools{margin:16px 0!important;padding:12px!important}.developer-actions{grid-template-columns:1fr!important}.developer-actions button{width:100%!important}
}
@media(max-width:390px){:root{--guard-height:88px}.sandbox-status{max-width:124px}.spmt-space-main{padding-inline:9px!important}.spmt-hero{padding:17px 13px!important}.spmt-metrics{gap:7px!important}.spmt-metrics>div{padding:11px!important}.spmt-rocket-dock{left:5px!important;right:5px!important}.spmt-rocket-dock nav label{font-size:7px!important}}
`;
