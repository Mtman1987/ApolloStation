// Canonical fallback artwork from the deployed Nebula source at 42cb640.
...
export function renderQuackverseCanonicalArt(card:typeof quackverseCards[number]){return card.type==='Equipment'?equipmentSvg(card):duckSvg(card);}
