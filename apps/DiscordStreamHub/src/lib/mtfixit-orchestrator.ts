...
async function sendRotatorRequest(path: string, init: RequestInit, headers: Record<string, string>) {
...
export async function decideChatGptHandoff(handoffId: string, action: 'approve' | 'deny') {
