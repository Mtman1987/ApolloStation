...
export * from "./simulation-room.js";
...
export * from "./suite-action-operations.js";
...
export * from "./channel-moderation.js";
export * from "./signal-control.js";
export * from "./signal-presentation.js";
export * from "./card-pack-render.js";
export * from "./quackverse-art.js";
export * from "./quackverse-pack-publisher.js";
export * from "./settings.js";
export * from "./web-controls.js";
export const DISCORD_ANNOUNCEMENT_REQUESTED="dsh.discord.announcement.requested.v1";
export const manifest=assertAppModuleManifestV1({schemaVersion:1,manifestVersion:"spmt.app-manifest/v1",id:"discord-stream-hub",name:"Discord Stream Hub",description:"Discord community, shoutout, calendar, moderation, forums, media, and canonical SPMT points workflows.",capabilities:["live-monitoring","shoutouts","shoutout-groups","spotlight","community-spotlight-banner","discord-live-delivery","discord-message-edit","calendar","participation-inquiries","moderation","channel-nuke","forums","clips","ten-gif-sixty-second-rotation","nebula-gameplay-rotation","nebula-stale-capture-recovery","role-aware-banner-gif","quackverse-art-enhance","quackverse-hover-gif","quackverse-art-job-worker","card-pack-gif-rendering","card-pack-message-upgrade","signal-seeker","signal-presentation","signal-inline-removal","durable-tenant-settings","points","leaderboard","wallet-settlement","provider-identity","provider-points-ingress","tenant-balances","simulation-rooms"],surfaces:["shell","standalone","overlay"],requiredScopes:["assistants:invoke","jobs:write","events:read","events:write","identity:read","identity:write","identity:onboard","providers:grant","runtime:write","jobs:claim","xp:read","xp:write"],eventTypes:[DISCORD_ANNOUNCEMENT_REQUESTED],integration:{identity:"connected",events:"native",commlink:"connected",workspace:"connected"},workers:[{id:"dsh-live-monitor",role:"provider-monitoring-and-discord-delivery",execution:"anchored",canonicalAuthority:false},{id:"dsh-clip-worker",role:"clip processing, 60-second gameplay capture, card-pack capture, Quackverse art enhancement, and deterministic GIF rendering",execution:"elastic",canonicalAuthority:false}]} satisfies AppModuleManifestV1);
