...
export class DshLoungeOverlayWeb {
  ...
  private overlay(response: ServerResponse, url: URL) {
    ...
    response.writeHead(200, { "content-type": "text/html; charset=utf-8", "cache-control": "no-store", "content-security-policy": "default-src 'self'; img-src 'self' https: data:; media-src 'self' https:; style-src 'unsafe-inline'; script-src 'unsafe-inline'; connect-src 'self'; frame-src 'self'; frame-ancestors *" });
...
html,body{margin:0;width:100%;height:100%;overflow:hidden;background:#030713;color:white;font-family:system-ui,-apple-system,Segoe UI,sans-serif}*{box-sizing:border-box}.stage{position:relative;width:100vw;height:100vh;background:radial-gradient(circle at 65% 35%,#17305d66,transparent 40%),linear-gradient(145deg,#040715,#09152d 55%,#050918)}.stars{position:absolute;inset:0;opacity:.25;background-image:radial-gradient(#fff 1px,transparent 1px);background-size:52px 52px}.brand{position:absolute;left:4vw;top:4vh;font-weight:900;letter-spacing:.14em;font-size:clamp(18px,2vw,34px)}.brand small{display:block;font-size:.42em;letter-spacing:.3em;opacity:.7;margin-top:.5em}.card{position:absolute;left:5vw;top:17vh;width:min(64vw,1100px);height:min(58vh,720px);min-height:45vh;padding:0;overflow:hidden;border:1px solid #8fdcff44;border-radius:32px;background:#000;box-shadow:0 25px 80px #0009,0 0 55px #39b8ff18}.spotlight-media{position:absolute;inset:0;width:100%;height:100%;border:0;background:#000}.hmo-card{position:absolute;right:3vw;top:5vh;width:min(24vw,440px);height:min(24vh,270px);min-width:260px;min-height:150px;overflow:hidden;border:1px solid #8fdcff44;border-radius:20px;background:#000;box-shadow:0 18px 50px #0008,0 0 35px #39b8ff14}.hmo-media{display:block;width:100%;height:100%;border:0;background:#000}.card-info{position:absolute;z-index:2;left:0;right:0;bottom:0;padding:clamp(18px,2.6vw,38px);background:linear-gradient(transparent,#030713e8 35%,#030713f7);pointer-events:none}.eyebrow{text-transform:uppercase;letter-spacing:.2em;color:#8fdcff;font-size:clamp(13px,1.3vw,22px)}h1{font-size:clamp(38px,5.8vw,92px);line-height:.98;margin:.18em 0}.detail{font-size:clamp(18px,2vw,34px);line-height:1.35;opacity:.86;max-width:92%}.meta{display:flex;gap:14px;flex-wrap:wrap;margin-top:28px}.pill{padding:9px 14px;border:1px solid #8fdcff44;border-radius:999px;background:#0e2449aa;font-size:clamp(12px,1vw,17px)}.stella{position:absolute;right:3vw;bottom:4vh;width:min(27vw,430px);height:min(58vh,630px);display:grid;place-items:end center}.stella img{max-width:100%;max-height:100%;image-rendering:auto;filter:drop-shadow(0 15px 28px #000b) drop-shadow(0 0 22px #2cc7ff55)}.stella .name{position:absolute;right:0;bottom:0;padding:8px 16px;border-radius:999px;background:#071126dd;border:1px solid #8fdcff55;font-weight:800}.ticker{position:absolute;left:0;right:0;bottom:0;height:42px;display:flex;align-items:center;padding:0 4vw;background:#06142ae8;border-top:1px solid #8fdcff33;font-size:clamp(13px,1.15vw,20px);white-space:nowrap;overflow:hidden}.maintenance{color:#ffd56a}.hidden{display:none!important}@media(max-aspect-ratio:4/3){.card{width:68vw}.hmo-card{right:2vw;width:27vw;min-width:220px}.stella{width:29vw;bottom:2vh}}
</style></head><body><main class="stage"><div class="stars"></div><div class="brand">SPACEMOUNTAIN.LIVE<small>COMMUNITY LOUNGE</small></div><section class="card"><iframe class="spotlight-media" src="/spotlight-media/player" title="Spotlight Media" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe><div class="card-info"><div id="eyebrow" class="eyebrow">Community online</div><h1 id="headline">SpaceMountainLive Lounge</h1><div id="detail" class="detail">Loading community systems…</div><div class="meta"><span id="mode" class="pill">LOUNGE</span><span id="audience" class="pill hidden"></span><span id="target" class="pill hidden"></span><span id="restart" class="pill"></span></div></div></section><section class="hmo-card" aria-label="HearMeOut Lounge media"><iframe class="hmo-media" src="/watch?embed=1&roomId=system-spacemountainlive-lounge" title="HearMeOut shared Lounge output" allow="autoplay; fullscreen" allowfullscreen></iframe></section><aside class="stella"><img id="stella" alt="Stella"><div class="name">STELLA · HOST</div></aside><div id="ticker" class="ticker">Welcome to the SpaceMountain community.</div><audio id="speech" preload="auto"></audio></main><script>
