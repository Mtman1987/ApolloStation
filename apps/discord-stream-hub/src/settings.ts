...
export interface DshTenantSettingsV1 { schemaVersion: 1; tenantId: string; captainMinimumDays: number; spotlightChannelId?: string; signalChannelId?: string; gifStorageChannelId?: string; groupChannels: Record<string, string>; embedTemplates?: DshEmbedTemplates; pollIntervalSeconds: number; spotlightEnabled: boolean; signalSeekerEnabled: boolean; revision: number; }
