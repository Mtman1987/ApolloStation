export const DSH_BOT_ACTIONS = ["dsh.shoutouts.active.read", "dsh.shoutouts.live.read", "dsh.shoutouts.post", "dsh.calendar.read", "dsh.calendar.captain.read", "dsh.calendar.captain.create", "dsh.calendar.event.create", "dsh.calendar.deploy", "dsh.calendar.refresh", "dsh.applications.read", "dsh.applications.deploy", "dsh.applications.decide"] as const;
