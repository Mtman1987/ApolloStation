...
export interface StreamWeaverGenerationSettings {provider:"automatic"|"seaart-cli"|"edenai";edenModel?:string;contentModeration?:boolean;publicAccess:"everyone"|"mods"|"off";modelNo:string;modelVerNo:string;resolution:string;count:number;seed:number;enhance:boolean;promptTemplate:string;providerParams:Record<string,string|number|boolean>;}
