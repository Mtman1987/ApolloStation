...
import { getAthenaRepairAudit, renderAthenaRepairAuditText } from "./repairAudit.js";
...
${spmtSharedUiHead("athena-repair")}<style id="spmt-suite-background">
...
</script>${spmtSharedUiScript("athena-repair", "/athena/api/settings")}</body></html>`;
}
