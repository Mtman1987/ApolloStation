...
- Reward-backed check-ins follow-up: repository build and all 913 offline tests passed, including paid-crash recovery, stable SPMT quotes, first-claim awards and browser retry after refresh failure. Promotion remains to be verified.
