...
- Bulk ride follow-up: repository build and all 936 offline tests passed, including restart recovery after bonus settlement, SPMT price preservation, eligibility identity boundaries, front-seat rotation, single-overlay delivery, owner controls and chatter pagination. Promotion remains to be verified.
