...
- Eden model catalog/selection follow-up: repository build and all 915 offline tests passed. Promotion for this batch remains to be verified.
...
| 5. Image Studio completion | Partial | SeaArt/Eden generation and worker-backed Eden model discovery/selection implemented. SeaArt catalog/LoRA browsing, character workflow, content controls and additional legacy providers remain. |
